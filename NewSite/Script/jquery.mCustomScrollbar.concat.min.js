    ...
    var b = {
        init: function (e) {
            ...
            return this.each(function () {
                ...
                m.wrapInner("<div class='mCustomScrollBox mCS-" + e.theme + "' id='mCSB_" + c(document).data("mCustomScrollbar-index") + "' style='height:100%; overflow:hidden; max-width:100%;' />").addClass("mCustomScrollbar _mCS_" + c(document).data("mCustomScrollbar-index"));
                var g = m.children(".mCustomScrollBox");
                if (e.horizontalScroll) {
                    g.addClass("mCSB_horizontal").wrapInner("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />");
                    var k = g.children(".mCSB_h_wrapper");
                    // alert(k.children().outerWidth());
                    if (e.width_style == 1) {
                ...
                o.after("<div class='mCSB_scrollTools' style='position:absolute;margin-bottom:100px;'><div class='mCSB_draggerContainer'><div class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' style='position:relative;'></div></div><div class='mCSB_draggerRail'></div></div></div>");
        ...
        update: function () {
            ...
            if (n.data("horizontalScroll")) {
                var A = y.children(".mCSB_buttonLeft"),
                    ...
                    f = k.width();
                //  alert('3rd ' + f);
                // alert('my width ' + $('.mCustomScrollBox').width());
                    ...
                    c(document).bind("MSPointerMove." + k.data("mCustomScrollbarIndex"), function (H) {
                        ...
                        if (k.data("on_drag")) {
                            var G = j,
                                ...
                                F = H.originalEvent.pageX - J.left,
                                I = H.originalEvent.pageY - J.top;
                            var leftval = $('.mCSB_container').offset().left;
                            locationMsg(leftval);
                            D(n, o, I, F)
                        }
